...
class XCRNN(nn.Module):

    def __init__(self, input_channel=1, output_channel=512, hidden_size=256, num_class=2):
        super(XCRNN, self).__init__()
        """ FeatureExtraction """
...
class MICRNN(nn.Module):
    def __init__(self, num_class):
        super(MICRNN, self).__init__()
